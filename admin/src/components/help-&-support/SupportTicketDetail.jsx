                ...
                <div className="col-span-8">
                    ...
                    <div
                        ...
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-md font-medium">Conversation ({currentTicket.responses?.length || 0})</h3>
                            <button
...
function MessageBubble({ message }) {
    ...
    // user on LEFT
    const isAgent = message.role === 'admin' || message.role === 'team_member'
        ...
        <div className={`flex ${isAgent ? 'justify-end' : 'justify-start'}`}>
            <div
                ...
                <div
                    ...
                    style={{
                        color: isAgent ? 'rgba(255,255,255,0.85)' : 'var(--muted)'
                    }}>
