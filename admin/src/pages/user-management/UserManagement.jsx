...
setIsResetPasswordOpen(true);
      ...
      <ExportCsvDialog
        ...
        headers={[
          ...
          { label: "Popular Artist Links (Agg)", key: "agg_artist_links" },
          ...
          try {
            ...
            return usersToExport.map((u, index) => {
              ...
              return {
                ...
                youtube: u.socialMedia?.youtube || u.artistData?.youtubeLink || u.labelData?.youtubeLink || u.aggregatorData?.youtubeLink || "",
                facebook: u.socialMedia?.facebook || u.artistData?.facebookLink || u.labelData?.facebookLink || u.aggregatorData?.facebookUrl || "",
                instagram: u.socialMedia?.instagram || u.artistData?.instagramLink || u.labelData?.instagramLink || u.aggregatorData?.instagramUrl || "",
                ...
                agg_artist_links: joinArr(u.aggregatorData?.popularArtistLinks),
