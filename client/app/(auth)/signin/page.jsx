...
const Page = () => {
  ...
  return (
    <div
      ...
      className="w-screen bg-[#151A27] h-screen max-md:h-fit bg-cover bg-center overflow-hidden p-20 max-sm:px-4 flex justify-center items-center gap-10 max-md:flex-col"
    >
      {/* Left Side - Form */}
