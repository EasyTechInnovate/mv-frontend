    ...
    return (
        <div className="overflow-x-hidden ">
            ...
            <motion.div
                ...
                <div className="w-full h-auto shadow-custom bg-gradient-to-b from-[#1d2334] bg-[#151A27] rounded-3xl px-8 sm:px-14 py-10 text-white space-y-6 flex flex-col md:flex-row gap-8 ">
                    <div className="w-full md:w-[50%] space-y-6">
                        <h1 className={`${anton.className} text-3xl md:text-4xl`}>About Maheshwari Visuals</h1>

                        <div className="flex items-top mb-2">
                            <div className="mx-1 mt-1">•</div>
                            <h1 className="text-gray-300 text-sm md:text-base leading-relaxed">
                    ...
                    <div className="w-full md:w-[50%] h-[200px] md:h-[300px] flex items-center justify-center">
                        <Image
                            src={aboutimage}
                            alt="aboutus"
            ...
            <div className="w-full p-8 md:p-20 flex justify-center items-top gap-[50px] flex-col lg:flex-row lg:gap-8 ">
                <motion.div
                    initial={{ y: 100, opacity: 0 }}
                    whileInView={{ y: 0, opacity: 1 }}
                    transition={{ duration: 0.4, delay: 0.05 }}
                    viewport={{ once: true }}
                    className="w-full lg:w-[50%] h-auto shadow-custom bg-gradient-to-b from-[#1d2334] bg-[#151A27] rounded-3xl px-8 sm:px-14 py-10 text-white space-y-6">
                    <h1 className={`${anton.className} text-3xl md:text-4xl`}>🎧 MV Distribution</h1>
                    <div className="flex flex-wrap items-center mb-4 gap-2 mt-0 relative z-10 text-white">
                        <h1 className="text-center text-sm md:text-base">Your Music</h1>
                        <div className="h-[20px] w-1 bg-[#652CD6]"></div>
                        <h1 className="text-center text-sm md:text-base">everywhere</h1>
                        <div className="h-[20px] w-1 bg-[#652CD6]"></div>
                        <h1 className="text-center text-sm md:text-base">On your terms</h1>
                    </div>
                    {[
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="w-full lg:w-[50%] h-auto shadow-custom bg-gradient-to-b from-[#1d2334] bg-[#151A27] rounded-3xl px-8 sm:px-14 py-10 text-white space-y-6">
                    <h1 className={`${anton.className} text-3xl md:text-4xl`}>📣 MV Marketing</h1>
                    <div className="flex flex-wrap items-center mb-4 gap-2 mt-0 relative z-10 text-white">
                        <h1 className="text-center text-sm md:text-base">Campaigns that connect</h1>
                        <div className="h-[20px] w-1 bg-[#652CD6]"></div>
                        <h1 className="text-center text-sm md:text-base">Results that resonate</h1>
                    </div>
                    {[
            ...
            <div className="w-full p-8 md:p-20 flex justify-center items-top gap-[50px] flex-col lg:flex-row lg:gap-8 ">
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="w-full lg:w-[50%] h-auto shadow-custom bg-gradient-to-b from-[#1d2334] bg-[#151A27] rounded-3xl px-8 sm:px-14 py-10 text-white space-y-6">
                    <h1 className={`${anton.className} text-3xl md:text-4xl`}>🎬 MV Production</h1>
                    <div className="flex flex-wrap items-center mb-4 gap-2 mt-0 relative z-10 text-white">
                        <h1 className="text-center text-sm md:text-base">Crafting visuals that amplify your sound</h1>
                    </div>
                    {[
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="w-full lg:w-[50%] h-auto shadow-custom bg-gradient-to-b from-[#1d2334] bg-[#151A27] rounded-3xl px-8 sm:px-14 py-10 text-white space-y-6">
                    <h1 className={`${anton.className} text-3xl md:text-4xl`}>👕 Music Merch Company</h1>
                    <div className="flex flex-wrap items-center mb-4 gap-2 mt-0 relative z-10 text-white">
                        <h1 className="text-center text-sm md:text-base">Wear your sound</h1>
                        <div className="h-[20px] w-1 bg-[#652CD6]"></div>
                        <h1 className="text-center text-sm md:text-base">Sell your story</h1>
                    </div>
                    {[
            ...
            <div className="w-full p-8 md:p-20 flex justify-center items-top">
                <motion.div
                    ...
                    transition={{ duration: 0.4, delay: 0.05 }}
                    viewport={{ once: true }}
                    className="w-full h-auto shadow-custom bg-gradient-to-b from-[#1d2334] bg-[#151A27] rounded-3xl px-8 sm:px-14 py-10 text-white space-y-6">
                    {[
                        ...
                        <div
                            ...
                            <div className="mx-1 mt-1">•</div>
                            <h1
                                className="text-gray-300 text-sm md:text-lg italic text-center w-full">
                                {item}
                            </h1>
                        </div>
                    ))}
