...
import { FaUserShield, FaDatabase, FaShareAlt, FaCookieBite, FaLock, FaUserEdit, FaExternalLinkAlt, FaEnvelope, FaPhone } from 'react-icons/fa'

const PrivacyPolicyPage = () => {
  return (
    <div className="bg-[#151A27] min-h-screen flex flex-col w-full overflow-hidden items-center justify-center py-10 pt-[100px]">
      <HeadingText text="Privacy Policy" />
