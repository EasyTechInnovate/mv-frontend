...
import { getMySyncSubmissions, submitSyncRequest, getMyPlaylistPitchingSubmissions, submitPlaylistPitchingRequest } from '../../services/api.services'
                    ...
                    <CardContent className="p-8 space-y-8">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <InputWithLabel
                                    ...
                                    disabled={isViewOnly}
                                    onChange={(e) => handleInputChange('sync', 'trackName', e.target.value)}
                                />
                                <InputWithLabel
                                    id="artistName"
                                    label="Artist Name"
                                    ...
                                    disabled={isViewOnly}
                                    onChange={(e) => handleInputChange('sync', 'artistName', e.target.value)}
                                />
                                <InputWithLabel
                                    id="labelName"
                                    label="Label Name"
                                    ...
                                    disabled={isViewOnly}
                                    onChange={(e) => handleInputChange('sync', 'labelName', e.target.value)}
                                />
                                <InputWithLabel
                                    id="isrc"
                                    ...
                                    value={data.isrc}
                                    disabled={isViewOnly}
                                    onChange={(e) => handleInputChange('sync', 'isrc', e.target.value)}
                                />
                                <SelectWithLabel
                                    id="genres"
                                    label="Genres"
                                    value={data.genres}
                                    disabled={isViewOnly}
                                    onValueChange={(value) => handleInputChange('sync', 'genres', value)}
                                ...
                                <SelectWithLabel
                                    ...
                                    value={data.mood}
                                    disabled={isViewOnly}
                                    onValueChange={(value) => handleInputChange('sync', 'mood', value)}
                                    options={moodOptions}
                                />
                                <SelectWithLabel
                                    id="isVocalsPresent"
                                    ...
                                    disabled={isViewOnly}
                                    onValueChange={(value) => handleInputChange('sync', 'isVocalsPresent', value)}
                                ...
                                <SelectWithLabel
                                    ...
                                    onValueChange={(value) => handleInputChange('sync', 'language', value)}
                                ...
                                <div className="md:col-span-2">
                                    <SelectWithLabel
                                        ...
                                        value={data.theme}
                                        disabled={isViewOnly}
                                        onValueChange={(value) => handleInputChange('sync', 'theme', value)}
                                ...
                                <InputWithLabel
                                    ...
                                    value={data.tempoBPM}
                                    disabled={isViewOnly}
                                    onChange={(e) => handleInputChange('sync', 'tempoBPM', e.target.value)}
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <SelectWithLabel
                                    ...
                                    disabled={isViewOnly}
                                    onValueChange={(value) => handleInputChange('sync', 'masterRightsOwner', value)}
                                ...
                                <SelectWithLabel
                                    ...
                                    disabled={isViewOnly}
                                    onValueChange={(value) => handleInputChange('sync', 'publishingRightsOwner', value)}
                                ...
                                <div className="md:col-span-2">
                                    <SelectWithLabel
                                        ...
                                        disabled={isViewOnly}
                                        onValueChange={(value) => handleInputChange('sync', 'isFullyClearedForSync', value)}
                                ...
                                <InputWithLabel
                                    ...
                                    disabled={isViewOnly}
                                    onChange={(e) => handleInputChange('sync', 'proAffiliation', e.target.value)}
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            <InputWithLabel
                                ...
                                disabled={isViewOnly}
                                onChange={(e) => handleInputChange('sync', 'trackLinks', e.target.value)}
                            />
                        </div>
            ...
            <div>
                <div className="flex items-center gap-4 mb-6">
                    <Button
                        variant="outline"
                        size="icon"
                        onClick={() => handleBackToList('playlistPitching')}>
                        <ArrowLeft className="h-4 w-4" />
                    </Button>
                    <div>
                ...
                <Card>
                    <CardContent className="p-8 space-y-8">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <InputWithLabel
                                    ...
                                    value={data.trackName}
                                    disabled={isViewOnly}
                                    onChange={(e) => handleInputChange('playlistPitching', 'trackName', e.target.value)}
                                />
                                <InputWithLabel
                                    id="artistName"
                                    label="Artist Name"
                                    ...
                                    value={data.artistName}
                                    disabled={isViewOnly}
                                    onChange={(e) => handleInputChange('playlistPitching', 'artistName', e.target.value)}
                                />
                                <InputWithLabel
                                    id="labelName"
                                    label="Label name"
                                    ...
                                    value={data.labelName}
                                    disabled={isViewOnly}
                                    onChange={(e) => handleInputChange('playlistPitching', 'labelName', e.target.value)}
                                />
                                <InputWithLabel
                                    id="isrc"
                                    label="ISRC of the Track (Optional)"
                                    ...
                                    value={data.isrc}
                                    disabled={isViewOnly}
                                    onChange={(e) => handleInputChange('playlistPitching', 'isrc', e.target.value)}
                                />
                                <SelectWithLabel
                                    id="genres"
                                    label="Genres"
                                    value={data.genres}
                                    disabled={isViewOnly}
                                    onValueChange={(value) => handleInputChange('playlistPitching', 'genres', value)}
                                    options={genreOptions}
                                />
                                <SelectWithLabel
                                    id="mood"
                                    ...
                                    value={data.mood}
                                    disabled={isViewOnly}
                                    onValueChange={(value) => handleInputChange('playlistPitching', 'mood', value)}
                                    options={moodOptions}
                                />
                                <SelectWithLabel
                                    id="isVocalsPresent"
                                    ...
                                    value={data.isVocalsPresent}
                                    disabled={isViewOnly}
                                    onValueChange={(value) => handleInputChange('playlistPitching', 'isVocalsPresent', value)}
                                    options={vocalsPresentOptions}
                                />
                                <SelectWithLabel
                                    id="language"
                                    ...
                                    value={data.language}
                                    disabled={isViewOnly || !data.isVocalsPresent}
                                    onValueChange={(value) => handleInputChange('playlistPitching', 'language', value)}
                                    options={languageOptions}
                                />
                                <SelectWithLabel
                                    id="theme"
                                    ...
                                    value={data.theme}
                                    disabled={isViewOnly}
                                    onValueChange={(value) => handleInputChange('playlistPitching', 'theme', value)}
                                    options={themeOptions}
                                />
                                <SelectWithLabel
                                    id="selectedStore"
                                    ...
                                    disabled={isViewOnly}
                                    onValueChange={(value) => handleInputChange('playlistPitching', 'selectedStore', value)}
                        ...
                        {!isViewOnly && (
                            <div className="flex justify-center pt-4">
                                <Button
                                    onClick={() => handleFormSubmit('playlistPitching')}
                                    disabled={isSubmitting}
                                    className="bg-[#711CE9] hover:bg-[#6f14ef] text-white w-full md:w-auto px-10">
                                    Submit Ticket
                                </Button>
        ...
        <div className="min-h-screen bg-background text-foreground p-6">
            ...
            <div className="flex items-center gap-2 p-1 rounded-lg bg-card w-full max-w-lg my-6">
                <button
                    ...
                    className={`px-4 py-1.5 w-full  text-sm font-medium rounded-md transition-colors ${activeTab === 'sync' ? 'bg-muted-foreground/20 text-foreground shadow-sm' : 'text-muted-foreground hover:bg-muted-foreground/10'}`}>
                    Sync
                </button>
                <button
                    onClick={() => {
                        setActiveTab('playlistPitching')
                        setCurrentPage(1)
                    }}
                    className={`px-4 w-full py-1.5 text-sm font-medium rounded-md transition-colors ${activeTab === 'playlistPitching' ? 'bg-muted-foreground/20 text-foreground shadow-sm' : 'text-muted-foreground hover:bg-muted-foreground/10'}`}>
                    Playlist Pitching
                </button>
            </div>
                                                ...
                                                <tr
                                                    ...
                                                    <td className="p-4 text-center">
                                                        <Button
                                                            variant="outline"
                                                            size="sm"
                                                            onClick={() => handleView(activeTab, request)}
