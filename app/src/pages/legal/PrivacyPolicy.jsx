...
import { Shield, Database, Share2, Cookie, Lock, UserRoundCog, ExternalLink, Mail, Phone, Globe, Info, BellRing } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background pb-20">
      <div className="max-w-5xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="text-center space-y-4">
          <h1 className="text-4xl font-extrabold text-foreground tracking-tight uppercase">Privacy Policy</h1>
          ...
          <p className="max-w-3xl mx-auto text-lg text-muted-foreground leading-relaxed pt-4">
            Maheshwari Visuals ("we," "us," or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you visit our website (maheshwarivisuals.com, Dashboard.maheshwarivisuals.com) or use our services.
          </p>
        </div>
