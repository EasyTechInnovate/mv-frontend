...
const MetaClaimReleaseDetails = ({ details }) => {
                    ...
                    <Card key={index} className="border-slate-700">
                        ...
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <DetailItem label="Meta Video Link" value={claim.metaVideoLink} isLink />
                                <DetailItem label="Meta Audio Link" value={claim.metaAudioLink} isLink />
...
export default MetaClaimReleaseDetails;
